    ...
    <div class="addGood" v-loading="loading">
      ...
      <div class="addGoodPhoto">
        ...
        <el-upload
          ...
          :headers="{'Uname': this.$store.getters.username_getters, 'token': this.$store.getters.token_getters, 'goodId': 235, 'type': 2}"
          name="img">
      ...
      <el-button class="addGoodButton" type="warning" v-on:click="enter()">添加商品</el-button>
    </div>
</template>
